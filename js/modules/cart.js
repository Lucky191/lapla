...
var cart = (function($) {
    ...
    // Возвращаем общую сумму
    function getSumma2() {
        return _.reduce(cartData, function(sum, item) {return sum  + item.count * item.price-(item.count *item.price*10/100)}, 0);
    ...
    function renderTotalCartSumma() {
     ...
     // Рендерим общую сумму товаров
    function renderTotalCartSumma2() {
        $(opts.elTotalCartSumma2).html(getSumma2);
    }
